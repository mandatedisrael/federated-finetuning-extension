    ...
    },
    {
      ...
      render: () => (
        <div className="space-y-6">
          <div>
            <h1 className="font-serif text-4xl tracking-tight sm:text-5xl">
              Deposits are planned for later.
            </h1>
            <p className="text-foreground-muted mt-3 text-base leading-relaxed">
              We like the idea of a refundable deposit for spam resistance, but it is not active in
              this release. Contributors can join and submit without funding anything extra.
            </p>
          </div>

          <div className="border-border bg-surface-muted/40 rounded-[var(--radius-lg)] border border-dashed p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-foreground-muted mt-1 text-sm leading-relaxed">
                  We&apos;ll bring this back when escrow, refunds, and contributor messaging are
                  ready end to end.
                </p>
              </div>
