 ...
 * 
 * Example:
 *   node download-ffe-lora.js 1 0xabc123def456 ./ffe-lora.bin
 */

import { writeFileSync } from 'fs';
import { resolve } from 'path';
import { FFE } from './dist/index.js';
...
async function main() {
  ...
  if (args.length < 2) {
    ...
    console.error('  node download-ffe-lora.js 1 0xabc123def456 ./ffe-lora.bin');
    process.exit(1);
  }
  ...
  try {
    ...
    console.log(`[FFE Download] Fetching token ID for session ${sessionId}...`);
